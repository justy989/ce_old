...
TESTS=test_ce test_vim test_auto_complete test_buffer test_command test_completion test_info test_input test_jump test_misc test_text_history
...
test_jump: test_jump.c jump.test.o ce.test.o
	$(CC) $(CFLAGS) $^ -o $@ $(LINK) -lpthread
	./$@ 2>> test_output.txt || (cat test_output.txt && false)

test_misc: test_misc.c misc.test.o ce.test.o syntax.test.o command.test.o view.test.o info.test.o ce.test.o buffer.test.o vim.test.o misc.test.o destination.test.o jump.test.o terminal.test.o terminal_helper.test.o input.test.o text_history.test.o ce_config.test.o auto_complete.test.o completion.test.o tab_view.test.o
	$(CC) $(CFLAGS) $^ -o $@ $(LINK) -lpthread
	./$@ 2>> test_output.txt || (cat test_output.txt && false)

test_text_history: test_text_history.c text_history.test.o
	$(CC) $(CFLAGS) $^ -o $@ $(LINK) -lpthread
	./$@ 2>> test_output.txt || (cat test_output.txt && false)
